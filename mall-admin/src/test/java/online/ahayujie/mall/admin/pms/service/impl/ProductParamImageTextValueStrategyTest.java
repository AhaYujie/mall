...
@SpringBootTest
@Transactional
class ProductParamImageTextValueStrategyTest {
    @Autowired
    private ProductParamImageTextValueStrategy strategy;
    ...
    void validate() {
        ...
        Throwable throwable2 = assertThrows(IllegalProductParamException.class, () -> strategy.validate("{\"image\" : \"test\"}"));
